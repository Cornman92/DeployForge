        ...
        try:
            ...
            subprocess.run(
                [
                    "reg",
                    "add",
                    f"{hive_key}\\Microsoft\\Windows\\CurrentVersion\\Diagnostics\\DiagTrack",
                    "/v",
                    "ShowedToastAtLevel",
                    "/t",
                    "REG_DWORD",
            ...
            subprocess.run(
                [
                    "reg",
                    "add",
                    f"{hive_key}\\Microsoft\\Windows\\CurrentVersion\\Privacy",
                    "/v",
        ...
        try:
            ...
            subprocess.run(
                [
                    "reg",
                    "add",
                    f"{hive_key}\\Policies\\Microsoft\\Windows\\DeliveryOptimization",
                    "/v",
                    "DODownloadMode",
                    "/t",
                    "REG_DWORD",
